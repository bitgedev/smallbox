...
<!-- 					fmt:parseDate - String 타입 날짜 형식 변경 -->
				...
				<td>
					<input type="button" value="취소" onclick="location.href='ReserveCancel.my?member_id=${sessionScope.sId}&res_num=${reserve.res_num }'"><br>
				</td>
				<td>
					<input type="button" value="작성" onclick="location.href='ReserveCancel.my?member_id=${sessionScope.sId}&res_num=${reserve.res_num }'"><br>
				</td>
			</tr>
		</c:forEach>
	</table>
