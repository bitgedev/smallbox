...
<%--                    			<div class="text-center"><a class="btn btn-outline-dark mt-auto" href="MovieLikePro.mv?member_id=${sessionScope.sId }&movie_idx=${movie.movie_idx}">찜</a></div> --%>
<%--                     	</c:when> --%>
<%--                     	<c:otherwise> --%>
<%--                     		<div class="text-center"><a class="btn btn-outline-dark mt-auto" href="CancelMovieLikePro.mv?member_id=${sessionScope.sId }&movie_idx=${movie.movie_idx}">찜해제</a></div> --%>
<%--                     	</c:otherwise> --%>
<%--                     </c:choose> --%>
